...
- The 1.6.0 Windows ZIP passed an isolated exact-package launch with honest RT presentation and clean exit. The exact signed 1.6.0 Android APK is now installed and pulled back byte-for-byte on `SM-S948B`; strict ASTC, `RayTracingPipeline`, honest RT presentation, Home/resume, and a short route smoke passed. Deterministic feature timing/replay and owner-feel evidence remain tied to the accepted Debug runtime.

...
- Showcase Alpha 0.1.4 now publishes the two-skeleton/parry runtime on Windows and Android. Final exact reconciliation runtime commit `547d89d` passed strict ASTC, honest RT presentation, fresh 12/12 Debug and Release CTests, Android build/lint, replay, 13 captures, Home/resume, exact installed-Debug-APK matching, and owner feedback; its sustained last-in-order lich was 23.069 ms in the descriptive 30-50 FPS band at GPU thermal power level 2. Release source `f0cba09` changes identity/packaging only relative to that runtime. Windows itch build `#1903586` was launched from its exact ZIP; Android build `#1903587` passed certificate/package checks but was published while the phone was disconnected. See `docs/CURRENT_DEVELOPMENT_BASELINE_VALIDATION_2026-08-21.md` and `docs/SHOWCASE_ALPHA_0_1_4_RELEASE_VALIDATION_2026-08-22.md`.

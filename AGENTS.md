...
- The published complete showcase route remains Windows- and Android-device-validated at one active skinned enemy. Historical exact two-skeleton commit `b3428a7` passed its own gate and owner hands-on check. Final exact reconciliation runtime commit `547d89d` passed strict ASTC, honest RT presentation, fresh 12/12 Debug and Release CTests, Android build/lint, replay, 13 captures, Home/resume, and exact installed-APK matching; its sustained last-in-order lich was 23.069 ms in the descriptive 30-50 FPS band at GPU thermal power level 2. The owner reported that event-time spatial audio sounded good on the earlier exact candidate; final-candidate audio/haptic/stagger confirmation remains pending and must not be inferred from automation. See `docs/HORDE_SHOWCASE_ANDROID_VALIDATION_2026-07-17.md`, `docs/TWO_SKELETON_COMBAT_ANDROID_VALIDATION_2026-08-12.md`, and `docs/CURRENT_DEVELOPMENT_BASELINE_VALIDATION_2026-08-21.md`.
...
- Current Vulkan-enabled host configurations have twelve CTests; final clean Full run `run-20260821-184821` passed 12/12 in fresh Debug and Release, 13 pixel-identical Windows captures, Android Debug/unsigned Release/lint, packaging/licence checks, shader checks, exact device validation, and evidence hashes. The portable CI lane has eight Vulkan-disabled tests and passed on PR #14 at the previous pushed commit, but does not prove hardware RT or yet cover the latest local commits.

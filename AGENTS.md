...
- Current Vulkan-enabled host configurations have 31 CTests. Exact 1.6.0 source Host run `run-20260831-131431` passed fresh Debug/Release 31/31 CTests, 13 Windows captures, Android Debug/unsigned Release/lint, strict ARM64 asset math, packaging/licence, shader freshness, and evidence hashing. The portable CI lane remains Vulkan-disabled and does not prove hardware RT.

...
- The Windows-first complete showcase route is implemented: lower body and lantern drop, bounded skylight/torch/transmission/mirror lighting, spatial audio, and sequential skeleton/lich selection. Preserve the one-active-skinned-enemy limit until phone measurements. See `docs/HORDE_SHOWCASE_WINDOWS_VALIDATION_2026-07-16.md` and `docs/COLOURED_LIGHT_ROUTE_PLAN_2026-07-15.md`.

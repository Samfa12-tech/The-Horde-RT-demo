...
- Current Vulkan-enabled host configurations have twelve CTests; current Debug and established-directory Release each pass 12/12. The portable CI lane has eight Vulkan-disabled tests and passed on PR #14, but does not prove hardware RT. The canonical fresh Host runner remains pending because local Smart App Control blocked two fresh Release hashes before launch.

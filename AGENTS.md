...
- Two simultaneous skeletons are the hard development ceiling. Do not add a third/fourth enemy, broader AI, block/dodge, or unrelated gameplay. Keep the lich singular. The automated phone gate is passed; do not claim owner-approved readability, audio/haptic distinction, or combat feel until the hands-on check is reported.

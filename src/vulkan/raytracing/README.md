...
- `RayTracingPipeline` when `VK_KHR_acceleration_structure`, `VK_KHR_ray_tracing_pipeline`, `VK_KHR_buffer_device_address`, `VK_KHR_deferred_host_operations`, and required feature structs are present.

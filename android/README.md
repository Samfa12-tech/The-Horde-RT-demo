...
The exact signed 1.6.0 APK is published as itch build `#1931951`; SHA-256 `52a64255ad5dec82cc866fb2ea3545be498ca06c73a789019be851c77e5d6c48`. The established certificate, identity, version, credits, strict package layout, static C++ runtime, APK/ELF compatibility, native libraries, runtime assets, licence checks, and lint passed. No ADB device was connected at publication, so this exact signed APK has not received install, pullback, strict-ASTC runtime, honest-presentation, performance, or Home/resume release smoke. The same final feature runtime was accepted on exact Debug APK `0b5a59b6e41d2c4d717eff885aaa310b7f5f1512002f6a89cb77e5989ab7edd3`; that does not convert into signed-package evidence. See `../docs/SHOWCASE_ALPHA_1_6_0_RELEASE_VALIDATION_2026-08-30.md`.

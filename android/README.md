...
The current showcase release identity is `0.1.5-alpha.1` with `versionCode 6`. Public candidates must be signed by the established Horde release key, retain strict ASTC routing and 16 KiB compatibility, and pass the guarded package/push verification; never replace the existing update identity with a new keystore.

The exact signed 0.1.5 APK is published as itch build `#1908331`; SHA-256 `1e81238a6e1b0e934c50eb15e80fc8efd39c06f16ca8960c428b22e5f5d5a7f2`. The established certificate, version, credits, strict package layout, waterfall asset, static C++ runtime, APK/ELF 16 KiB alignment, and native libraries passed. The APK was upgraded on `SM-S948B`, pulled back byte-for-byte, and passed strict ASTC plus honest RT presentation before and after Home/resume. See `../docs/SHOWCASE_ALPHA_0_1_5_RELEASE_VALIDATION_2026-08-23.md`.

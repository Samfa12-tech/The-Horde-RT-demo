...
- **Owner correction, 2026-09-23:** the source is to be treated as a **right hand**. The earlier left-handed classification is withdrawn. The historical runtime placed the unmirrored source on `LeftHand` and mirrored it for `RightHand`; a correct bone name did not make that mesh assignment anatomically correct. The new opt-in processor mode `--gauntlet-source-hand Right` mirrors the source for Left and preserves it for Right, including matching winding/UV-corner reversal. It generates a separate paired world/viewmodel candidate; the admitted runtime below has not silently been replaced. Old no-option export compatibility exists only to reproduce that historical baseline pending corrected-candidate admission. Source bytes, prompts and licence terms remain unchanged.
...
- Current tracked player runtime GLB SHA-256: `e8737f10e7669b284e04109d9c3acdf537df284093a21511656bf191a70450fd`; 3,058,292 bytes. Admitted on 2026-09-23 after repeatable single-thread export, static/skinned addressing checks and five byte-identical native RTX pose comparisons against previous `cd64a8447097f59f825620ef43e2425f9286ff075f5bfdb48c25c5d96f2c479d`. This is technical runtime admission, not subjective first-person arm acceptance. Source assets and licence statements are unchanged; see `docs/evidence/2026-09-23-player-admission/README.md`.
- Current runtime geometry (reconciled against the unchanged GLB on 2026-09-20): 27,775 triangles; 33,894 processing vertices; 41,530 upload vertices; 83,325 glTF-expanded vertices/indices; four semantic primitives. `BodyPrimaryVisible` contains 5,532 triangles, `GauntletPrimaryVisible` 8,838, `HeadPrimaryMasked` 1,813, and `NearFacePrimaryMasked` 11,592. See `docs/evidence/2026-09-20-player-regeneration/README.md` for decoded counts and separate clean-export evidence; no source/runtime GLB was replaced during this reconciliation.

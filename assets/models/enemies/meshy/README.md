...
- The runtime selects it after the skylight gate, but never renders/refits it concurrently with the skeleton. The Android debug APK packages it for compile continuity; phone validation and public distribution remain gated.

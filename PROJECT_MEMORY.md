...
- Approved Pixabay chest-unlock, chest-opening, and torch-extinguish cues are routed from ordered shared gameplay events. With the exact final Debug candidate still installed on `SM-S948B`, the owner accepted the natural reward route, two-second unlock timing, audio, and haptics.
...
- Showcase Alpha `1.6.0` / `versionCode 8` is published as Android itch build `#1931951`, SHA-256 `52a64255ad5dec82cc866fb2ea3545be498ca06c73a789019be851c77e5d6c48`. The APK passed the established certificate, identity, signed-package, ABI, strict runtime-asset/licence, and lint guards. On 2026-08-31 it was installed and pulled back byte-for-byte on exact `SM-S948B`; strict ASTC, `RayTracingPipeline`, honest RT presentation, and Home/resume passed, with no fatal marker during a short route smoke. This is functional/presentation evidence, not deterministic checkpoint/replay or sustained Release performance/owner-feel evidence. The same feature runtime was accepted on exact final Debug APK `0b5a59b6e41d2c4d717eff885aaa310b7f5f1512002f6a89cb77e5989ab7edd3` before the release-only version/signing/package delta.
...
- Final post-publication closeout Host run `run-20260831-135300` repeated all seven stages from clean commit `8d69ed0`; the updated negative gates rejected 1.6.0 rebuild/upload and Android `versionCode 8`.

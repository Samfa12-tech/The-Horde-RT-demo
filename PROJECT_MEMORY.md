...
- Current reconciliation source includes Android press-down parry and listener-at-event-time feedback routing. Exact candidate `4a4d360` / APK `fa160e84ffd655a3504d4e19e5025b1addddc4f862586c38a2f5743811cd026a` passed strict ASTC, honest RT presentation, matched GPU-timing A/B, replay, 13 captures, and Home/resume. Later exact `88868f4` sustained diagnostics found flat graphics/native/PSS/RSS/thread state while Samsung reduced the GPU from 1300 MHz to 578-646 MHz at GPU thermal power level 7; this supersedes the hard 20 ms rule with descriptive 60/50/30 FPS bands and a matched-regression investigation policy. Canonical clean Host run `run-20260821-170907` passes 12/12 Vulkan-enabled tests in fresh Debug/Release plus the full Host foundation, and PR #14 CI passes 8/8 portable tests. The owner reported that audio sounds good on the exact installed candidate; exact-candidate haptic confirmation remains pending. The published 0.1.3 artifacts remain unchanged. See `docs/CURRENT_DEVELOPMENT_BASELINE_VALIDATION_2026-08-21.md`.

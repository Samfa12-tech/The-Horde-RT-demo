...
- Current exact runtime/authority candidate `4a4d360` includes Android press-down parry and listener-at-event-time feedback routing. Debug APK SHA-256 `fa160e84ffd655a3504d4e19e5025b1addddc4f862586c38a2f5743811cd026a` installed byte-for-byte on `SM-S948B` and passed strict ASTC, honest RT presentation, the cooled six-checkpoint 75% gate, matched GPU-timing A/B, replay, 13 captures, and Home/resume. Current Debug and established-directory Release each pass 12/12 Vulkan-enabled tests, and PR #14 CI passes 8/8 portable tests. The canonical fresh Host runner remains pending because Smart App Control blocked two fresh Release hashes before launch, and the owner event-time audio/haptic baseline remains pending. The published 0.1.3 artifacts remain unchanged. See `docs/CURRENT_DEVELOPMENT_BASELINE_VALIDATION_2026-08-21.md`.
